...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('img/logojensoed.png') }}">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top shadow">
        <div class="container">
            <a class="navbar-brand nav-home" href="/">
                <div class="nav-brand">
                    <img classname="d-sm-none d-md-block" src="{{url('assets/images/logo/logojensoed.png')}}"  alt="">
                    <img classname="d-sm-block d-md-none" src="{{url('assets/images/logo/logojensoed.png')}}"  alt="">
                </div>
            </a>
