...
<head>
    ...
    <link href="{{url('img/logojensoed.png')}}" rel="icon" type="image/png">
...
<body style="background-color: #f5f5f5;">
    <div class="limiter">
        ...
        <div class="login-pic js-tilt" data-tilt> 
          <center>
            <img style="margin-center:10px" src="{{url('assets/images/museum (4).jpeg')}}" width="300px" height="500px"alt="Museum Jensoed">
          </center>
				</div>
        <form role="form" action ="/login" method="post">
          @csrf
				<span class="login-form-title">
					<img src="{{url('assets/images/logo/logojensoed.png')}}" width="220px" alt="Logo">
				</span>
